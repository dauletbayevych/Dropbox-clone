    ...
    return (
        ...
        <div className="flex flex-wrap items-center justify-start mt-4">
            <div className="flex items-center">
                ...
                <button onClick={() => navigate('/workspace/')} className="text-cyan-500 hover:text-cyan-600 disabled:text-gray-500" disabled={currentLocation === home}>
                    Your Drive
                </button>
                ...
                {pathArray.map((location, index) => {
                    ...
                    if (index != 0) { /* to not print home */
                        return (
                            <div key={location}>
                                <button onClick={() => navigate(path)} className="text-cyan-500 hover:text-cyan-600 disabled:text-gray-500" disabled={currentLocation === location}>
                                    {location}
                                </button>
                                <span className="text-gray-600">/</span>
                            </div>
